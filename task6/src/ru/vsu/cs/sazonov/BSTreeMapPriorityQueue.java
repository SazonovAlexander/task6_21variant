...
import ru.vsu.cs.sazonov.bst.avl.AVLTreeMap;

import java.util.List;
import java.util.Map;
import java.util.TreeMap;

public class BSTreeMapPriorityQueue implements TreeMapPriorityQueue{

    private final AVLTreeMap<Integer, AVLTreeMap<Integer, Object>> queue = new AVLTreeMap<>();
    ...
    public void insert(Integer key, Object value){
        if (queue.containsKey(key)){
            ...
            AVLTreeMap<Integer, Object> map = new AVLTreeMap<>();
            map.put(1, value);
            queue.put(key, map);
        }
    }
